...
**Primary reference:** [`KoreoReaderModal.tsx`](https://github.com/thecont1/koreo/blob/main/client/src/components/KoreoReaderModal.tsx)  
**Authoring reference:** [`AuthoringStudio.tsx`](https://github.com/thecont1/koreo/blob/main/client/src/pages/AuthoringStudio.tsx)
...
| --- | --- | --- |
| Article page | Presents the untouched source photograph and opens the reader only on intent. | [`Humahuaca.tsx`](https://github.com/thecont1/koreo/blob/main/client/src/pages/Humahuaca.tsx), [`CinqueTerre.tsx`](https://github.com/thecont1/koreo/blob/main/client/src/pages/CinqueTerre.tsx) [1] |
| koreo reader | Owns focus, camera movement, captions, navigation, preference persistence, and dialog behavior. | [`KoreoReaderModal.tsx`](https://github.com/thecont1/koreo/blob/main/client/src/components/KoreoReaderModal.tsx) [2] |
| Authoring Studio | Creates, edits, saves, and reloads stories while previewing the source image in a chosen window. | [`AuthoringStudio.tsx`](https://github.com/thecont1/koreo/blob/main/client/src/pages/AuthoringStudio.tsx) [3] |
| Styling layer | Defines reader orientation, stage sizing, caption rails, focus geometry, and responsive behavior. | [`index.css`](https://github.com/thecont1/koreo/blob/main/client/src/index.css) [4] |
...
| [2] | [Reader implementation](https://github.com/thecont1/koreo/blob/main/client/src/components/KoreoReaderModal.tsx) |
| [3] | [Authoring Studio implementation](https://github.com/thecont1/koreo/blob/main/client/src/pages/AuthoringStudio.tsx) |
| [4] | [Reader and Studio styles](https://github.com/thecont1/koreo/blob/main/client/src/index.css) |
