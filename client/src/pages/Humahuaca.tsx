...
const humahuacaSteps: KoreoReaderStep[] = [
  ...
  { label: "dark slopes / provisional", title: "Muted green-gray weathering", body: "Weathered shale or siltstone, volcanic-derived sediment, or altered fine-grained sedimentary rock. The fine grain, crumbly surface, and muted green-gray weathering define the right slope and foreground.", x: 77, y: 55, zoom: 1.2, accent: "#6e806f", shape: "rect", size: 28 },
  { label: "pale bank / provisional", title: "A young, sandy edge", body: "Sandy silt, sandstone-derived material, and young alluvial sediment. Light-colored fine sediment is mixed here with sand and gravel along the left bank.", x: 18, y: 57, zoom: 1.2, accent: "#d49b43", shape: "rect", size: 23 },
  { label: "dry channel / provisional", title: "The channel between rains", body: "Unconsolidated alluvium: mud, sand, gravel, and cobbles recently transported by intermittent water flow. The dry channel runs from the middle distance toward the foreground.", x: 54, y: 68, zoom: 1.18, accent: "#8a6954", shape: "rect", size: 31 },
  { label: "background ridges / provisional", title: "Layers tilted into the distance", body: "Tilted layers of sandstone, shale or siltstone, and possibly conglomerate. The repeating banded texture is typical of layered sedimentary rocks in the background ridges.", x: 61, y: 32, zoom: 1.18, accent: "#7a5c76", shape: "rect", size: 25 },
];
