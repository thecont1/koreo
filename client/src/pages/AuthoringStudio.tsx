    ...
    <div className="author-shell">
      <main className="author-workbench">
        <aside className="author-panel author-setup-panel">
          ...
          <div className="author-upload-row"><button type="button" onClick={() => fileInputRef.current?.click()}><Upload size={15} /> Load Image</button><span>{imageSize.width} × {imageSize.height}</span><input ref={fileInputRef} type="file" accept="image/*" onChange={handleImageFile} hidden /></div>
